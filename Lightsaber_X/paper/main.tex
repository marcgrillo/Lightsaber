...
\begin{figure}[t]
  ...
  noise-split duplicates, see text); rolling fraction near-optimal (within
  $\tfrac12\hat\sigma$ of the best controller) for RA-TS-F, the rule-based
  policy, and D-UCB. RA-TS-F recovers to near-optimal play within
